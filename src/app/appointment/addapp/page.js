            ...
            <div className='cardBox'>
                <div className="cardBoxTitle bg-light">
                    <div className='d-flex align-items-center justify-content-between'>
                        <div><h6 className="fw-semibold mb-0">Search Patient</h6></div>
                    </div>
                </div>
                    ...
                    <form action="">
                        ...
                        <div className='row mb-3'>
                            <div className='col-md-6 mb-1'>
                                <div className="mb-1">
                                    <label htmlFor="team" className="col-form-label">Patient ID</label>
                            ...
                            <div className='col-md-6 mb-1'>
                                <div className="mb-1">
                                    <label htmlFor="team" className="col-form-label">Address</label>
                                    <input type="text" className="form-control" id="team" />
                                </div>
                                <div className="mb-1">
                                ...
                                <div className="mb-1">
                                    <label htmlFor="team" className="col-form-label">Exact match</label>
                                    <select className="form-control" name="match" id="match">
